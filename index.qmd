...
Seismic lines represent a major source of habitat fragmentation in Alberta’s Upper Athabasca Region, disrupting ecosystem structure and function by reducing connectivity, increasing edge effects, and altering bird behaviour [@dabros2018; @lee2006; @bayne2005].

![Map of the study area in Alberta’s Upper Athabasca Region.](assets/Fig1.jpg){#fig-fig1}

With nearly 168,000 km of linear features within the study area, representing \$1.7B in reclamation deficit, prioritizing restoration efforts is essential to maximize conservation impact within ﬁnancial constraints. Our objective is to identify areas of high conservation value with and without seismic cost considerations and to develop a simple strategic classification of **Protect**, **Restore**, and **Manage** to inform conservation planning and land use management.
